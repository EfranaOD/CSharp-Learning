...
namespace _07_surprise_conv_challenge
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            byte b = Convert.ToByte(f); //same like int, gets converted to whole number which is near from float point. if the value of f was 257.78f then this line would throw an exception
